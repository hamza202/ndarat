    ...
    <div class="top-header">
        <div class="container">
            <ul class="linda-nav top-bar-menu left">
                <li class="menu-item">
                    <a title="info@gimbaegroup.com" href="#"><span class="icon fa fa-envelope-o "></span>info@gimbaegroup.net</a>
                </li>
            </ul>
            <ul class="linda-nav top-bar-menu right">
                ...
                <li class="menu-item-has-children currency">
                    <a role="button" href="#"><span>USD</span></a>
                    <ul class="submenu">
                        <li class="switcher-option  active ">
                            <a href="#" data-currency="USD">USD</a>
                        </li>
                        <li class="switcher-option ">
                            <a href="#" data-currency="SR">SR</a>
                        </li>
                    </ul>
                </li>
            </ul>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-ts-12 col-xs-6 col-sm-6 col-md-2">
                    <div class="logo">
                        <a href="index.php">
                            <img alt="Linda" class="imglina" src="images/logo.png">
                        </a>
                    </div>
                </div>
                <div class="col-md-8 hidden-sm hidden-xs hidden-ts">
                            ...
                            <div class="widget_shopping_cart_content">
                                ...
                                <div class="mini-cart-content">
                                    <div class="minicart-content-wrapper">
                                        ...
                                        <div class="actions">
                                            <a class="button small border btn-viewcart" href="shopping-cart.php">
                                                <span>View cart</span>
                                            </a>
                                            <a href="shopping-checkout.php" class="button small btn-checkout">
                                                <span>Check out</span>
                                            </a>
                                        </div>
                                    </div>
